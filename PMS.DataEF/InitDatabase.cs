	...
	public class InitDatabase
	{
		...
		public async Task Seed()
		{
			...
			if (_context.Projects.Count() == 0)
			{
				...
				{
					new ProjectTask{Name = "Project Task 2", Description = "Project Task 2", PriorityValue = 2, WorkingStatusValue = 2, Project = projects[0], KanbanColume= kanbanColumes[0], Order = 2, StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(5)},
					new ProjectTask{Name = "Project Task 1", Description = "Project Task 1", PriorityValue = 1, WorkingStatusValue = 1, Project = projects[0], KanbanColume= kanbanColumes[0], Order = 1, StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(7)},
					new ProjectTask{Name = "Project Task 3", Description = "Project Task 3", PriorityValue = 3, WorkingStatusValue = 1, Project = projects[0], KanbanColume= kanbanColumes[0], Order = 3, StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(3), Dependencies = "1,2"},
					new ProjectTask{Name = "Project Task 4", Description = "Project Task 4", PriorityValue = 3, WorkingStatusValue = 1, Project = projects[0], KanbanColume= kanbanColumes[0], Order = 4, StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(10)},
					new ProjectTask{Name = "Project Task 5", Description = "Project Task 5", PriorityValue = 3, WorkingStatusValue = 1, Project = projects[0], KanbanColume= kanbanColumes[0], Order = 5, StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(14)}
				};
			...
			{
				var project1 = await _context.Projects.Where(p => p.Name.Equals("Singleton")).FirstOrDefaultAsync();
